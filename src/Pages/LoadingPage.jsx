...
export default function LoadingPage() {
    return (
        <>
            <div className="flex justify-center items-center bg-linear-[135deg] from-purple-500 to-pink-500  w-full h-screen" aria-label="Loading..." role="status"><svg className="h-12 w-12 animate-spin stroke-white" viewBox="0 0 256 256">
